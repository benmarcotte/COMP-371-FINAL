#ifndef STRAIGHT_RENDERABLE_H
#define STRAIGHT_RENDERABLE_H
...
class StraightPath: public Renderable {
public:
    // renderable Data
    vector<Model> models;
    ...
    StraightPath()
    {
        models.push_back(Model("resources/objects/straight_path/straight_path.obj"));
